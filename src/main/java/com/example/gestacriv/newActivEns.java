...
public class newActivEns {
    public static void refreshEncad(javafx.scene.control.Label encad,javafx.scene.control.Label typeEncad,javafx.scene.control.Label npLaureat,javafx.scene.control.Label l1,int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query = "SELECT * FROM encad where ens_id_fk = "+ens_id+" AND encad_id = (SELECT max(encad_id) AS maxID FROM encad);";
    ...
    public static void refreshSout(javafx.scene.control.Label sout,javafx.scene.control.Label intituleSout,javafx.scene.control.Label npSout,javafx.scene.control.Label dateSout,javafx.scene.control.Label lieuSout,javafx.scene.control.Label l2,javafx.scene.control.Label l3, int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query = "SELECT * FROM sout where ens_id_fk = "+ens_id+" AND sout_id = (SELECT max(sout_id) AS maxID FROM sout);";
        try (Connection con = DriverManager.getConnection(url, user, password);
             PreparedStatement pst = con.prepareStatement(query)) {
            ResultSet s = pst.executeQuery();
            if (s.isBeforeFirst()){
    ...
    public static void refreshRespo(javafx.scene.control.Label respo,javafx.scene.control.Label descrespo,int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query = "SELECT * FROM respo where ens_id_fk = "+ens_id+" AND resp_id = (SELECT max(resp_id) AS maxID FROM respo);";
    ...
    public static void refreshManif(javafx.scene.control.Label natureManif,javafx.scene.control.Label natureParticip,javafx.scene.control.Label dateManif,javafx.scene.control.Label lieuManif,javafx.scene.control.Label l4,javafx.scene.control.Label l5,int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query = "SELECT * FROM manif where ens_id_fk = "+ens_id+" AND manif_id = (SELECT max(manif_id) AS maxID FROM manif);";
    ...
    public static void refreshProjet(javafx.scene.control.Label titre,javafx.scene.control.Label desc,javafx.scene.control.Label duree,javafx.scene.control.Label budget,int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query = "SELECT * FROM projet where ens_id_fk = "+ens_id+" AND projet_id = (SELECT max(projet_id) AS maxID FROM projet);";
        ...
        try (Connection con = DriverManager.getConnection(url, user, password);
            ...
            if (s.isBeforeFirst()){
                while (s.next()){
                    desc.setVisible(true);duree.setVisible(true);budget.setVisible(true);
                    titre.setText(s.getString("titreP"));
                    desc.setText(s.getString("descP"));
                    duree.setText(s.getString("jourP"));
                    budget.setText(s.getString("budgP"));
                }
            }else {
                desc.setText("Aucune Projet de recherche");
                titre.setVisible(false);
                duree.setVisible(false); budget.setVisible(false);
            }
        } catch (SQLException ex) {
    ...
    public static void refresh4Encad(javafx.scene.control.Label encad1,javafx.scene.control.Label encad2,javafx.scene.control.Label encad3,javafx.scene.control.Label encad4
            ...
            ,javafx.scene.control.Label l11,javafx.scene.control.Label l12,javafx.scene.control.Label l13,javafx.scene.control.Label l14, int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query1 = "SELECT * FROM encad where ens_id_fk = "+ens_id+" order by encad_id desc OFFSET 4-1 LIMIT 1;";
        String query2 = "SELECT * FROM encad where ens_id_fk = "+ens_id+" order by encad_id desc OFFSET 4-2 LIMIT 1;";
        String query3 = "SELECT * FROM encad where ens_id_fk = "+ens_id+" order by encad_id desc OFFSET 4-3 LIMIT 1;";
        String query4 = "SELECT * FROM encad where ens_id_fk = "+ens_id+" order by encad_id desc OFFSET 4-4 LIMIT 1;";    //Latest one
    ...
    public static void refresh4Sout(javafx.scene.control.Label sout1,javafx.scene.control.Label sout2,javafx.scene.control.Label sout3,javafx.scene.control.Label sout4
            ...
            ,javafx.scene.control.Label l311,javafx.scene.control.Label l312,int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query1 = "SELECT * FROM sout where ens_id_fk = "+ens_id+" order by sout_id desc OFFSET 4-1 LIMIT 1;";
        String query2 = "SELECT * FROM sout where ens_id_fk = "+ens_id+" order by sout_id desc OFFSET 4-2 LIMIT 1;";
        String query3 = "SELECT * FROM sout where ens_id_fk = "+ens_id+" order by sout_id desc OFFSET 4-3 LIMIT 1;";
        String query4 = "SELECT * FROM sout where ens_id_fk = "+ens_id+" order by sout_id desc OFFSET 4-4 LIMIT 1;";    //Latest one
    ...
    public static void refresh4Resp(javafx.scene.control.Label respoL1,javafx.scene.control.Label respoL2,javafx.scene.control.Label respoL3,javafx.scene.control.Label respoL4
        ...
        String query1 = "SELECT * FROM respo where ens_id_fk = "+ens_id+" order by resp_id desc OFFSET 4-1 LIMIT 1;";
        String query2 = "SELECT * FROM respo where ens_id_fk = "+ens_id+" order by resp_id desc OFFSET 4-2 LIMIT 1;";
        String query3 = "SELECT * FROM respo where ens_id_fk = "+ens_id+" order by resp_id desc OFFSET 4-3 LIMIT 1;";
        String query4 = "SELECT * FROM respo where ens_id_fk = "+ens_id+" order by resp_id desc OFFSET 4-4 LIMIT 1;";    //Latest one
        try (Connection con = DriverManager.getConnection(url, user, password);) {
            ResultSet s4 = con.prepareStatement(query4).executeQuery();
            if (s4.isBeforeFirst()){
                while (s4.next()){
    ...
    public static void refresh4Manif(javafx.scene.control.Label natureM1,javafx.scene.control.Label natureM2,javafx.scene.control.Label natureM3,javafx.scene.control.Label natureM4
        ...
        String query1 = "SELECT * FROM manif where ens_id_fk = "+ens_id+" order by manif_id desc OFFSET 4-1 LIMIT 1;";
        String query2 = "SELECT * FROM manif where ens_id_fk = "+ens_id+" order by manif_id desc OFFSET 4-2 LIMIT 1;";
        String query3 = "SELECT * FROM manif where ens_id_fk = "+ens_id+" order by manif_id desc OFFSET 4-3 LIMIT 1;";
        String query4 = "SELECT * FROM manif where ens_id_fk = "+ens_id+" order by manif_id desc OFFSET 4-4 LIMIT 1;";    //Latest oneString query4 = "SELECT * FROM manif where dr_id_fk = "+dr_id+" AND manif_id = (SELECT max(manif_id) AS maxID FROM manif);";    //Latest one
        try (Connection con = DriverManager.getConnection(url, user, password);) {
            ResultSet s4 = con.prepareStatement(query4).executeQuery();
            if (s4.isBeforeFirst()){
                while (s4.next()){
    ...
    public static void refresh4Proj(javafx.scene.control.Label titre1,javafx.scene.control.Label titre2,javafx.scene.control.Label titre3,javafx.scene.control.Label titre4
            ,javafx.scene.control.Label desc1,javafx.scene.control.Label desc2,javafx.scene.control.Label desc3,javafx.scene.control.Label desc4
            ,javafx.scene.control.Label duree1,javafx.scene.control.Label duree2,javafx.scene.control.Label duree3,javafx.scene.control.Label duree4
            ,javafx.scene.control.Label budget1,javafx.scene.control.Label budget2,javafx.scene.control.Label budget3,javafx.scene.control.Label budget4
            ,int ens_id){
        String url = "jdbc:postgresql://localhost:5432/GestActivDB";
        String user = "Admin";
        String password = "gestactiv2022";

        String query1 = "SELECT * FROM projet where ens_id_fk = "+ens_id+" order by projet_id desc OFFSET 4-1 LIMIT 1;";
        String query2 = "SELECT * FROM projet where ens_id_fk = "+ens_id+" order by projet_id desc OFFSET 4-2 LIMIT 1;";
        String query3 = "SELECT * FROM projet where ens_id_fk = "+ens_id+" order by projet_id desc OFFSET 4-3 LIMIT 1;";
        String query4 = "SELECT * FROM projet where ens_id_fk = "+ens_id+" order by projet_id desc OFFSET 4-4 LIMIT 1;";    //Latest oneString query4 = "SELECT * FROM manif where dr_id_fk = "+dr_id+" AND manif_id = (SELECT max(manif_id) AS maxID FROM manif);";    //Latest one
        try (Connection con = DriverManager.getConnection(url, user, password);) {
            ResultSet s4 = con.prepareStatement(query4).executeQuery();
            if (s4.isBeforeFirst()){
                while (s4.next()){
                    titre1.setVisible(true);duree1.setVisible(true);budget1.setVisible(true);
                    titre1.setText(s4.getString("titreP"));
                    desc1.setText(s4.getString("descP"));
                    duree1.setText(s4.getString("jourP"));
                    budget1.setText(s4.getString("budgP"));
                }
            }else {
                titre1.setVisible(false);
                desc1.setText("Aucune Projet de Recherche");
                budget1.setVisible(false);duree1.setVisible(false);
                //l41.setVisible(false);l42.setVisible(false);
            }
            ResultSet s3 = con.prepareStatement(query3).executeQuery();
            if (s3.isBeforeFirst()){
                while (s3.next()){
                    titre2.setVisible(true);duree2.setVisible(true);budget2.setVisible(true);
                    titre2.setText(s3.getString("titreP"));
                    desc2.setText(s3.getString("descP"));
                    duree2.setText(s3.getString("jourP"));
                    budget2.setText(s3.getString("budgP"));
                }
            }else {
                titre2.setVisible(false);
                desc2.setText("Aucune Projet de Recherche");
                duree2.setVisible(false);
                budget2.setVisible(false);
                //l43.setVisible(false);l44.setVisible(false);
            }
            ResultSet s2 = con.prepareStatement(query2).executeQuery();
            if (s2.isBeforeFirst()){
                while (s2.next()){
                    titre3.setVisible(true);duree3.setVisible(true);budget3.setVisible(true);
                    titre3.setText(s2.getString("titreP"));
                    desc3.setText(s2.getString("descP"));
                    duree3.setText(s2.getString("jourP"));
                    budget3.setText(s2.getString("budgP"));
                }
            }else {
                titre3.setVisible(false);
                desc3.setText("Aucune Projet de Recherche");
                duree3.setVisible(false);
                budget3.setVisible(false);
                //l43.setVisible(false);l44.setVisible(false);
            }
            ...
            if (s1.isBeforeFirst()){
                while (s1.next()){
                    titre4.setVisible(true);duree4.setVisible(true);budget4.setVisible(true);
                    titre4.setText(s1.getString("titreP"));
                    desc4.setText(s1.getString("descP"));
                    duree4.setText(s1.getString("jourP"));
                    budget4.setText(s1.getString("budgP"));
                }
            }else {
                titre4.setVisible(false);
                desc4.setText("Aucune Projet de Recherche");
                duree4.setVisible(false);
                budget4.setVisible(false);
                //l43.setVisible(false);l44.setVisible(false);
            }
        } catch (SQLException ex) {
